...
class Navbarmobile extends React.Component {
  ...
  render() {
    ...
    return (
      <Navbar className="bgNav ml-60.5" expand="lg">
        <Navbar.Brand>
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mr-auto">
            <Nav onMouseEnter={() => this.toNews('/')} onMouseLeave={() => this.cancelTimer()} ><Link to="/">Inicio</Link></Nav>
            ...
            <Nav><Link to="/noticias">Donaciones</Link></Nav>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
